...
myst_url_schemes = {
    ...
    "gh-issue": {
        "url": "https://github.com/radionets-project/radioft/issue/{{path}}#{{fragment}}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
}
...
json_url = "https://radioft.readthedocs.io/en/latest/_static/switcher.json"
...
html_theme_options = {
    "github_url": "https://github.com/radionets-project/radioft",
    ...
    "announcement": """
        <p>radioft is not stable yet, so expect large and rapid
